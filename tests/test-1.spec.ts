...
test('Проверка отображения элементов навигации хэдэра', async ({ page }) => {
...
test('Проверка названии элементов навигации хэдэра', async ({ page }) => {
  await page.goto('https://playwright.dev/');
  await expect
...
test('Проверка атрибутов href элементов навигации хэдэра', async ({ page }) => {
  await page.goto('https://playwright.dev/');
  await expect
    .soft(page.getByRole('link', { name: 'Playwright logo Playwright' }))
